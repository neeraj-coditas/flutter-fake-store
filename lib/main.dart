...
class _DashBoardState extends State<DashBoard> {
  ...
  Widget build(BuildContext context) {
    ...
    final drawerHeader = Container(
      height: 200.0,
      child: Center(
        child: FlutterLogo(size: 100.0), // Replace with your shopping app icon
      ),
    );
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return Card(
                    ...
                    child: Padding(
                      padding:
                          EdgeInsets.all(10.0), // Add padding to the content
                      child: Row(
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              image: DecorationImage(
                                ...
                                fit: BoxFit
                                    .contain, // Use BoxFit.contain to fit without cropping
                              ),
                            ),
                          ),
                          SizedBox(
                              width:
                                  10.0), // Add spacing between image and details
                          Flexible(
                            // Use Flexible for the details column
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text(
                                ...
                                const SizedBox(
                                    height:
                                        4.0), // Add spacing between description and price
                                Text(
                                  '\$${product.price.toStringAsFixed(2)}',
                                  style: const TextStyle(
                                      fontSize: 18.0,
                                      fontWeight: FontWeight
                                          .bold), // Increase font size and add bold
                                ),
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    SizedBox(
                                        width:
                                            10.0), // Add spacing between count buttons and button
                                    Container(
                                      margin: EdgeInsets.only(
                                          right:
                                              10.0), // Add margin to the right
